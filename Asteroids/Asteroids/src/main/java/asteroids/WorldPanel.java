    ...
    public void paintComponent(Graphics g) {
        ...
        while (iter.hasNext()) {
            ...
            if (entity != game.getPlayer() || game.canDrawPlayer()) {
                /*if (entity.getClass() == PowerUpSatelite.class && game.poderActivado()) { // si tiene power up dibujarle el circulo
                    Vector2 position = game.getPlayer().getPosition(); //Get the position of the entity.
                    drawEntity(g2d, entity, position.x - 30, position.y - 30);
