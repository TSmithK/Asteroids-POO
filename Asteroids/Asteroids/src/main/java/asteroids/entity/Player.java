...
public class Player extends EntityFriend {
     ...
     */
    private static int MAX_BULLETS = 4;
    ...
    private int posicionSateliteCounter = 5;

    private static int VELOCIDAD_MOVIMIENTO_SATELITE = 5;
    /**
    ...
    public int posicionActualSatelite() {
        return posicionSateliteCounter;
    }

    public void girarIzquierda() {
        this.posicionSateliteCounter = this.posicionSateliteCounter - VELOCIDAD_MOVIMIENTO_SATELITE;
    }
