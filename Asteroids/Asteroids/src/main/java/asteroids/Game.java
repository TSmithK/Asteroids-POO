...
public class Game extends JFrame {
     ...
     * will be vulnerable to collisions and the Player will regain the ability
     * to shoot.</p>
     */
     ...
     *
     * <p>
     * This timer adds a short delay that must expire before the game can be
     * reset, giving the player time to react.</p>
     */
    ...
    /**
     * Modificacion: agregamos variables para saber el tiempo restante y si
     * tiene power up
     */
     ...
     */
    public PowerUpSatelite powerSalelite = null;
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_P:
                        ...
                        break;
                    case KeyEvent.VK_C:
                        if (!checkForRestart() && poderActivado()) {
                    ...
                    default:
                        ...
                        case KeyEvent.VK_Q:
    if (!checkForRestart() && poderActivado()) {
        powerSalelite.rotarIzquierda();
    }
    break;

// Indicate that we want to rotate the shield to the right.
case KeyEvent.VK_E:
    if (!checkForRestart() && poderActivado()) {
        powerSalelite.rotarDerecha();
    }
    break;
            ...
            public void keyReleased(KeyEvent e) {
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_V:
                        ...
                        case KeyEvent.VK_Q:
    if (poderActivado()) {
        powerSalelite.detenerRotacion();  
    }
    break;

// Indicate that we no longer want to rotate the shield to the right.
case KeyEvent.VK_E:
    if (poderActivado()) {
        powerSalelite.detenerRotacion();  // Asegúrate de agregar un método detenerRotacion() en tu clase PowerUpSatelite
    }
    break;
                }
    ...
    /**
     * Check the user input to see if the key should be used to restart the
     * game.
     *
    ...
    private void startGame() {
        ...
        while (true) {
            ...
            logicTimer.update();
            /**
             * Modificacion: si vence el tiempo del power up, volver a false
             */
    ...
    /**
     * Modificacion: getter y seter de power up
     *
     * @param obtainPowerUp
     */
    public void setObtainPower(boolean obtainPowerUp) {
        ...
        if (!obtainPowerUp) {
            if (powerSalelite != null) {
                powerSalelite.flagForRemoval();
            }
            powerSalelite = null;
        }
    }
    ...
    public int getDuration() {
        ...
        return powerSalelite.obtenerVidaRestante();
    }
